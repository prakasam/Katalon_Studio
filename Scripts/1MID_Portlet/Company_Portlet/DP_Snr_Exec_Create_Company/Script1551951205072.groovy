...
WebUI.setText(findTestObject('Object Repository/1MID_Portlet/Super_User_Company-OR/input__companyName'), 'Apex Persatuan new company ')
...
WebUI.setText(findTestObject('Object Repository/1MID_Portlet/Super_User_Company-OR/input__regNo'), 'PP-78wr76-0099')
...
WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg 18'))

'selected check box for Sijil Perakuan Pendaftaran (compulsory)- CTC Copy'
WebUI.takeScreenshot()

WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg perReg.18'))

WebUI.delay(3)

//Sample path. Change it to your saved location of autoIT script
autoit_prj = 'D:\\workspace\\KSW\\UF\\PP\\Sijil_Perakuan_Pendaftaran_compulsory_CTC_Copy.exe'
...
WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg 19'))

'selected check box for Profail Terkini (compulsory)- CTC Copy '
WebUI.takeScreenshot()

WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg perList.19'))

WebUI.delay(3)

//Sample path. Change it to your saved location of autoIT script
autoit_prj = 'D:\\workspace\\KSW\\UF\\PP\\Senarai_Ahli_Lembaga_compulsory_CTC_Copy.exe'
...
WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg 20'))

'selected check box for  Copy of company director(s) and representative(s) MyKad'
WebUI.takeScreenshot()

WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg perCopy.20'))

WebUI.delay(3)

//Sample path. Change it to your saved location of autoIT script
autoit_prj = 'D:\\workspace\\KSW\\UF\\PP\\Copy_of_Ahli_Lembaga_MyKad_compulsory.exe'
...
WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg 21'))

'selected check box for Appointment Letter (Only if applicable) '
WebUI.takeScreenshot()

WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg perAppLetter.21'))

WebUI.delay(3)

//Sample path. Change it to your saved location of autoIT script
autoit_prj = 'D:\\workspace\\KSW\\UF\\PP\\Appointment_letter.exe'
...
WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg 37'))

'selected check box for  Authorization Letter'
WebUI.takeScreenshot()

WebUI.click(findTestObject('1MID_Portlet/Super_User_Company-OR/input_Note Please upload jpeg perCancelAp.37'))

WebUI.delay(3)

//Sample path. Change it to your saved location of autoIT script
autoit_prj = 'D:\\workspace\\KSW\\UF\\PP\\Cancellation_of_Authorized_Personnel.exe'
