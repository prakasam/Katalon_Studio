...
WebUI.setText(findTestObject('Object Repository/1MID_Portlet/General/input_Email Address__58_login'), 'dataprocover@liferay.com')

WebUI.setEncryptedText(findTestObject('Object Repository/1MID_Portlet/General/input_Password__58_password'), 'POeQ1a4GSSS3kULL8vOEAg==')
...
'Clicked Add Role button , it will display the message " Warning : You do not have the credential.\r\nPlease contact your Administrator. "'
WebUI.takeScreenshot()
...
'Clicked Edit button , it will display the message " Warning : You do not have the credential.\r\nPlease contact your Administrator. "'
WebUI.takeScreenshot()
