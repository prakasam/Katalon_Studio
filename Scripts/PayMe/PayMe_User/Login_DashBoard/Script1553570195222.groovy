...
WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/Login_DashBoard_Forgot_Password_OR/i_PayMe by MyEG_fa fa-tasks'))

'click notification '
WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/Login_DashBoard_Forgot_Password_OR/p_Ahmad Albab Abdullah Approvedtimesheet from Oct 28 2018(Sunday) to Nov 03 2018 (Saturday)'))

'it will open the selected notification page '
WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/Login_DashBoard_Forgot_Password_OR/a_Aplus edited'))

'Clicked User name from top rightside corner to select sign out '
WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/Login_DashBoard_Forgot_Password_OR/a_Sign out'))
...
not_run: WebUI.switchToWindowTitle('Gmail - Free Storage and Email from Google')

not_run: WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/Login_DashBoard_Forgot_Password_OR/a_Sign in'))

not_run: WebUI.switchToWindowTitle('Gmail')
...
WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/Login_DashBoard_Forgot_Password_OR/span_Search_gb_ya gbii'))
