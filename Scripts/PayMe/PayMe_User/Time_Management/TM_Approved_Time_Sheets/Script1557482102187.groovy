...
'clicked Approved time sheets link , it will open page'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/input_records per page_form-control'), '2019-03-03')
...
WebUI.setText(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/input_records per page_form-control'), '60:04')
...
WebUI.setText(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/input_records per page_form-control'), 'Approved')
...
WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_User_OR/TM_Time_Sheets/img_Approved_tableActionButton'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/a_Approved TimeSheets'), FailureHandling.OPTIONAL)

WebUI.waitForPageLoad(5)

'clicked Approved timesheets link to get back page '
WebUI.takeScreenshot()

WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_Start Date_a'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_Start Date'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_End Date_a'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_End Date'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_Total Time_a'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_Total Time'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_Status_a'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/th_Status'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_User_OR/TM_Time_Sheets/Approved_OR/a_2'))
