...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/E_Employee_Monitor_Attendance/span_alert(1) alert(1)'))
...
WebUI.setText(findTestObject('Object Repository/PayMe_OR/PayMe_Admin_OR/E_Employee_Monitor_Attendance/input_Employee_s2id_autogen2_search'), 
    'april')
...
WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_Admin_OR/E_Employee_Monitor_Attendance/a_admin (1)'))
...
WebUI.click(findTestObject('Object Repository/PayMe_OR/PayMe_Admin_OR/E_Employee_Monitor_Attendance/a_Sign out'))
