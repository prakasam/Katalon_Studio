...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/a_Ethnicity'))

WebUI.waitForPageLoad(5)

'clicked ethnicity  link  , it will open the page '
WebUI.takeScreenshot()

WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/button_Add New'))
...
WebUI.setText(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/input__name'), 'Thailand')

'click save with given details '
WebUI.takeScreenshot()

WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/button_Save'))

WebUI.waitForPageLoad(5)

'it will save the data and auto redirect to ethnicity page '
WebUI.takeScreenshot()

WebUI.setText(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/input_records per page_form-control'), 
    'Thailand')
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/img_Thailand_tableActionButton_edit'))
...
WebUI.setText(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/input__name'), 'Thailand Edit')
...
'it will save the data and auto redirect toethnicity  page '
WebUI.takeScreenshot()
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/img_Thailand edit_tableActionButton_copy'))
...
'click save with given required info , it will save the data '
WebUI.takeScreenshot()
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/img_Thailand edit_tableActionButton'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/button_Delete'))

WebUI.waitForPageLoad(5)

'clicked Delete button, it will delete the record , it will auto redirect to ethnicity page '
WebUI.takeScreenshot()
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/th_Name_a'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/th_Name'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Ethnicity/a_2'), FailureHandling.OPTIONAL)
