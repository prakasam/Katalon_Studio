...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/a_Immigration Status'))

WebUI.waitForPageLoad(5)

'clicked Immigration Status link  , it will open the page '
WebUI.takeScreenshot()

WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/button_Add New'))
...
WebUI.setText(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/input__name'), 'contractor permit')

'click save with given details '
WebUI.takeScreenshot()

WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/button_Save'))

WebUI.waitForPageLoad(5)

'it will save the data and auto redirect to Immigration Status  page '
WebUI.takeScreenshot()

WebUI.setText(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/input_records per page_form-control'), 
    'contractor permit')
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/img_contractor permit_tableActionButton_edit'))
...
WebUI.setText(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/input__name'), 'contractor permit edit')
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/img_contractor permit edit_tableActionButton_copy'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/img_contractor permit edit_tableActionButton'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/button_Delete'))

WebUI.waitForPageLoad(5)

'clicked Delete button, it will delete the record , it will auto redirect to Immigration Status page '
WebUI.takeScreenshot()
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/th_Name_a'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/th_Name'))
...
WebUI.click(findTestObject('PayMe_OR/PayMe_Admin_OR/S_Manage_Metadata/Immigration_Status/a_2'), FailureHandling.OPTIONAL)
