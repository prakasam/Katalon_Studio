...
not_run: WebUI.click(findTestObject('Pasti/Pasti_Business_User_OB/Pasti_RouteReplay_OB/Page_Pasti by MyEG/svg'), FailureHandling.OPTIONAL)

not_run: WebUI.setText(findTestObject('Pasti/Pasti_Business_User_OB/Pasti_RouteReplay_OB/Page_Pasti by MyEG/input_Selected Date_date-picke'), 
...
not_run: WebUI.click(findTestObject('Pasti/Pasti_Business_User_OB/Pasti_RouteReplay_OB/Page_Pasti by MyEG/a_Logout'))
