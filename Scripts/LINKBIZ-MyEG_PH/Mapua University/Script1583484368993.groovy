...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_MU'))

WebUI.waitForPageLoad(5)

'selected Mapua University'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_Back Account_MU'))

WebUI.waitForPageLoad(5)

'selected transaction type as "Back Account" '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'santosh')

WebUI.waitForPageLoad(5)

'given Payor/Student Name'
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'santosh edit')

WebUI.waitForPageLoad(5)

'edited Payor/Student Name'
WebUI.takeScreenshot()
