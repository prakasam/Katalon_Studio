...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_CEPAL'))

WebUI.waitForPageLoad(5)

'selected Cagayan Electric Power and Light Co. Inc.'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_Electric Bill CEPAL'))
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Registered Name CEPAL'), 'l')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Registered Name CEPAL'), 'ramana electric')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account No Contract ID CEPAL'), 'electric-75634')

WebUI.waitForPageLoad(5)

'given Account No./ Contract ID'
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Registered Name CEPAL'), 'ramana electric edit')

WebUI.waitForPageLoad(5)

'edited Registered Name'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account No Contract ID CEPAL'), 'electric-75634e')

WebUI.waitForPageLoad(5)

'edited Account No./ Contract ID'
WebUI.takeScreenshot()
