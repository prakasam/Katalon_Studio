...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_CEC'))

WebUI.waitForPageLoad(5)

'selected Cagayan I Electric Cooperative Inc.'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_Electric Bill CEC'))

WebUI.waitForPageLoad(5)

'selected transaction type as " Electric Bill " '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'ramana electric')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Bill Amount CEC'), '₱155.99')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_10Digit CAGELCO Account No CEC'), '8765432999')

WebUI.waitForPageLoad(5)

'given 10-Digit CAGELCO Account No.'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Bill Period (YYYYMM) CEC'), '202103')

WebUI.waitForPageLoad(5)

'given Bill Period (YYYYMM)'
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'ramana electric edit ')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Bill Amount CEC'), '₱1557.77')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_10Digit CAGELCO Account No CEC'), '8765432777')

WebUI.waitForPageLoad(5)

'edited 10-Digit CAGELCO Account No.'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Bill Period (YYYYMM) CEC'), '202110')

WebUI.waitForPageLoad(5)

'edited Bill Period (YYYYMM)'
WebUI.takeScreenshot()
