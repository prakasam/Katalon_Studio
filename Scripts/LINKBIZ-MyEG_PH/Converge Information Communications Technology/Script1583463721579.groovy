...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_CICT'))

WebUI.waitForPageLoad(5)

'selected Converge Information Communications Technology'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_Internet Bill CICT'))

WebUI.waitForPageLoad(5)

'selected transaction type as " Water Bill " '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Name CICT'), 'l')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Number CICT'), 'inter-75634')

WebUI.waitForPageLoad(5)

'given Subscriber\'s Account Number'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Name CICT'), 'ramana internet')

WebUI.waitForPageLoad(5)

'given Subscriber\'s Name'
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Transaction Date CICT'), '03/20/2021')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Number CICT'), 'inter-75634e')

WebUI.waitForPageLoad(5)

'edited Subscriber\'s Account Number'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Name CICT'), 'ramana internet edit')

WebUI.waitForPageLoad(5)

'edited Subscriber\'s Name'
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Transaction Date CICT'), '10/09/2021')

WebUI.waitForPageLoad(5)

'edited Transaction Date'
WebUI.takeScreenshot()
