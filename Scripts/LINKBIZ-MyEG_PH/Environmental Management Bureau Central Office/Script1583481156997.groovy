...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_EMBCO'))

WebUI.waitForPageLoad(5)

'selected Environmental Management Bureau Central Office'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_Certificate of Non Coverage EMBCO'))

WebUI.waitForPageLoad(5)

'selected transaction type as " Certificate of Non Coverage " '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'Gopal')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Agency Code EMBCO'), 'AG-5432999')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Project Name EMBCO'), 'Complete HR System ')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'Gopal edit')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Agency Code EMBCO'), 'AG-5432777')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Project Name EMBCO'), 'Complete HR System update ')
