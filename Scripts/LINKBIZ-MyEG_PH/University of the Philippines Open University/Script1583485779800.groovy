...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_UPOU'))

WebUI.waitForPageLoad(5)

'selected University of the Philippines Open University'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_UPOU Revolving Fund UPOU'))

WebUI.waitForPageLoad(5)

'selected transaction type as "UPOU Revolving Fund" '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'l')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Payee Name CEC'), 'Varaprasad')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_student_number MU'), 'STU-420')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Program UPOU'), 'Anual day')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Purpose of payment UPOU'), 'Annual Day Fee ')

WebUI.waitForPageLoad(5)

'given Purpose of payment'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Reference Number UPOU'), 'Ref-85669')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_student_number MU'), 'STU-101')

WebUI.waitForPageLoad(5)

'edited Student Number'
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Program UPOU'), 'Anual day edited')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Purpose of payment UPOU'), 'Annual Day Fee edited')

WebUI.waitForPageLoad(5)

'edited Purpose of payment'
WebUI.takeScreenshot()

WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Reference Number UPOU'), 'Ref-85669e')
