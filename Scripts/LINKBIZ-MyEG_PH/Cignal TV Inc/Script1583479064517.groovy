...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_CTV'))

WebUI.waitForPageLoad(5)

'selected Cignal TV Inc.'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_Bills Payment CTV'))

WebUI.waitForPageLoad(5)

'selected transaction type as " Bills Payment " '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Name CTV'), 'l')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Name CTV'), 'ramana electric')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Number CICT'), '8765432999')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Name CTV'), 'ramana electric edit ')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Account Number CICT'), '8765432777')
