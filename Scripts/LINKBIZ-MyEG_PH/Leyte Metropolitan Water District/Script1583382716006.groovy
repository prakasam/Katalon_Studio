...
WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/img_Pay merchants anytime anywhere_LMWD'))

WebUI.waitForPageLoad(5)

'selected Leyte Metropolitan Water District'
WebUI.takeScreenshot()

WebUI.click(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Choose your transaction type_water bill LMWD'))
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Consumer name LMWD'), 'l')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Water_bill LMWD'), 'water-75634')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Consumer name LMWD'), 'ramana')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Meter Number LMWD'), 'WM43896')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Water_bill LMWD'), 'water-75634e')
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Consumer name LMWD'), 'ramana edit')

WebUI.waitForPageLoad(5)

'edited Consumer name '
WebUI.takeScreenshot()
...
WebUI.setText(findTestObject('LINKBIZ_PH/City Government of San Pedro Laguna/input_Meter Number LMWD'), 'WM43896e')
